export const CallGPTBaseline = async ({
  ...
  const init_prompt2 = `${persona}'s goal is to teach me about ${learning_objective} through conversation. You must remember this goal in all conversations. Remember the goal but don't reveal it explicitly in words, and achieve this goal through conversation. Ask questions actively.`;
